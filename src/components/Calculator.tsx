...
export default function Calculator({
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-5">
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-400">Planned Events per Year</span>
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-400">Expected Tickets/Event</span>
            ...
            <div>
              <div className="flex justify-between text-sm mb-2">
                <span className="text-gray-400">Avg Ticket Price (AED)</span>
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            {/* PL Fee */}
            <div className="bg-[#111827] rounded-xl border border-green-800/50 p-5">
              <p className="text-xs text-gray-400 uppercase tracking-wider mb-1">
          ...
          {/* Effective Rate */}
          <div className="bg-gradient-to-r from-[#111827] to-[#1a1f35] rounded-xl border border-[#1e293b] p-6">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              ...
              <div className="text-right">
                ...
                <p className="text-xs text-green-300 uppercase tracking-wider mt-1">
                  Net Rate Per Ticket
                </p>
              </div>
            </div>
            ...
            <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              {/* Marketing Credits */}
              <div className="bg-[#0d1117] rounded-lg p-4 border border-[#1e293b]">
              ...
              <div className="bg-[#0d1117] rounded-lg p-4 border border-[#1e293b]">
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-sm text-gray-400">Gross Fee</span>
            ...
            <div className="mt-4 bg-indigo-600 text-center rounded-lg py-2">
          ...
          <div className="bg-[#111827] rounded-xl border border-[#1e293b] p-6">
            <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
              <span className="text-indigo-400">₿</span> Revenue Projection
            </h3>
      ...
      <div className="bg-[#111827] rounded-xl border border-[#1e293b] p-6">
        <h3 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
          <span className="text-indigo-400">↗</span> Optimization Benchmarks
        </h3>
              ...
              {benchmarks.map((b, i) => (
                ...
                >
                  <td className="py-4 px-4">
                    <span
                      className={`${
                        i === 0 ? "text-white font-bold" : "text-gray-300"
                      }`}
                    >
                      {b.label}
                    </span>
                  ...
                  <td className="text-center py-4 px-4">
                    <span
                      className={`font-bold ${
                        i === 0 ? "text-indigo-400" : "text-gray-300"
                      }`}
                    >
                      {b.tierName}
                    </span>
